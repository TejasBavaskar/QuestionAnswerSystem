...
<html>
  <head>
    ...
    <title>cQA System| Ask Question</title>
                ...
                <h3>Optimization Ant Colony Algorithm</h3>
                 ...
                 <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="panel-heading"><!-- style="background-color: #66b3ff" -->
                        <!-- <h2 class="panel-title"> --><h4 align="center" style="font-family: Cambria;font-size: 23px;"><b>Ask a Question</b></h4>
                    </div>
                    <div class="panel-body">
                    <form action="askQuestionController" method="post" name="change">
                    <div class="form-group">
					<select name="q_type" id="q_type" class="form-control select2">
						<option selected="selected">Choose Question Type</option>
				    ...
				    <div class="form-group">
				    <textarea rows="5" cols="33" name="question" placeholder="Enter Question Here" required="required"></textarea>
      				</div>
      				<div class="form-group">
				    <textarea rows="5" cols="33" name="description" placeholder="Enter Question Description Here" required="required"></textarea>
      				</div>
      				...
      				<input type="submit" value="Submit"  style="width:90px;height: 34px;" class="btn btn-primary input-btn" />
                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
