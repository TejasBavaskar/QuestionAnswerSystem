      ...
      <div class="content-wrapper">
        ...
        <div class="col-xs-12 col-sm-10 col-md-10" align="left">
          ...
          UserService userService=new UserServiceImpl();
 			  ResultSet rs=userService.selectQuestions(q_id);
                ...
                <tr>
                  <td>
                   ...
                   <div class="col-sm-11">
                      <b style="font-size: 18px;"><%=rs.getString(3)%>?</b><br>
                      <%=rs.getString(4)%><br><br>
                      <div class="col-xs-10 col-sm-8 col-md-8" align="left">
			              <div class="login-panel panel panel-default">
				             <!-- <div class="panel-heading" align="left" style="font-family: Cambria;font-size: 23px;">User Log In</div> -->
				             <div class="panel-body">
					            <form role="form"  action="addAnswerController" method="post">
						         <fieldset>
							        <div class="form-group">
							            <textarea rows="8" cols="50" name="answer" placeholder="Add Your Answer..."></textarea>	
							        </div>
							           <input type="hidden" name="q_id" value="<%=rs.getInt(1)%>">
							           <input type="hidden" name="q_type" value="<%=rs.getString(2)%>">
							           <input type="hidden" name="question" value="<%=rs.getString(3)%>">
           ...
           <tr>
          <!--  <th>Discover</th> -->
           <th><h4><b>Answers</h4></th>
          <% UserService userService=new UserServiceImpl();
 			  ResultSet rs=userService.selectQuestions();
 			   while(rs.next()){%>
                <tr>
                  <td><b style="font-size: 18px;"><%=rs.getString(3)%>?</b><br>
                      <%=rs.getString(4)%><br><br>
				...
				<!-- <div class="panel-heading" align="left" style="font-family: Cambria;font-size: 23px;">User Log In</div> -->
				  <div class="panel-body">
					<form role="form"  action="addAnswerController" method="post">
						<fieldset>
							<div class="form-group">
							<textarea rows="4" cols="67" name="answer" placeholder="Add Your Answer..."></textarea>	
							</div>
							<input type="hidden" name="q_id" value="<%=rs.getInt(1)%>">
							<input type="hidden" name="q_type" value="<%=rs.getString(2)%>">
							<input type="hidden" name="question" value="<%=rs.getString(3)%>">
