            ...
            <li>
             ...
             <li>
              <a href="recommandedQuestions.jsp">
                <i class="fa fa-users"></i> <span>Recommended Questions</span> 
              </a>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="col-lg-12 connectedSortable">
         ...
         <div class="col-xs-12 col-sm-10 col-md-10" align="left">
           ...
           <table class="table">
           <tr>
           <th><h4><b>Recommended Questions</b></h4></th>
           </tr>
          <% ArrayList<String> question_al=new ArrayList<String>();
          ArrayList<String> notMatchedQue=new ArrayList<String>();
          HashSet<String> matchUser=new HashSet<String>();
          Map<String,ArrayList<String>> map=new HashMap<String,ArrayList<String>>();
          UserService userService=new UserServiceImpl();
          ResultSet rr=userService.getUserQuestions(email);
          while(rr.next())
          {
        	  String que=rr.getString(2);
        	  question_al.add(que);
          }
          System.out.println("question_al:"+question_al);
          
          for(String que:question_al)
          {
        	  ResultSet rrset=userService.getMachedUser(que,email);
        	  while(rrset.next())
        	  {
        		String userEmail=rrset.getString(3);  
        		matchUser.add(userEmail);
        	  }
          }
          System.out.println("Matched User:"+matchUser);
          int count=0;
         // int count1=0;
          for(String uemail:matchUser)
          {
        	  ResultSet rset=userService.getUserQuestions(uemail);
              while(rset.next())
              {
            	  String q=rset.getString(2);
            	  System.out.println("q:"+q);
            	  if(question_al.contains(q))
            	  {
            		   
            		  count=count+1; 
            		  System.out.println("que contains in al:"+q+" and count is "+count);
            	  }
            	  else
            	  {
            		  notMatchedQue.add(q);
              ...
              System.out.println("notMatchedQue:"+notMatchedQue);
              System.out.println("count:"+count);
              if(count>=3)
              {
            	 map.put(uemail, notMatchedQue);
            
              }
              System.out.println("Map:"+map);
        		  for (Map.Entry<String, ArrayList<String>> entry : map.entrySet())
        		  {
        		      ArrayList<String> all=entry.getValue();
        		      System.out.println("all:"+all);
        		      for(String ques:all)
        		      {
        		    	   System.out.println("ques:"+ques);
 			  ResultSet rs=userService.selectQuestions(ques);
 			   while(rs.next()){
 				   
 				   String uemailId=rs.getString(5);
 				  System.out.println("uemailId:"+uemailId);
 			   %>
                <tr>
                  <td>
                   <div class="col-sm-1">
