                ...
                <h3>Optimization Ant Colony Algorithm</h3>
                 ...
                 <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="panel-heading"><!-- style="background-color: #66b3ff" -->
                        <!-- <h2 class="panel-title"> --><h4 align="center" style="font-family: Cambria;font-size: 23px;"><b>Change Password</b></h4>
                    </div>
                    <div class="panel-body">
                    <form action="UserChangePassController" method="post" name="change">
                    
				    <div class="form-group">
      				<input type="text" name="old_password" placeholder="Enter Old Password" class="form-email form-control"
      				 id="form-email" pattern="^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,16}$" title="Password must contain 6 characters.In that at least 1 uppercase,1 lowercase,1 special symbol(!,@,#,$,%,^,&,*) and 1 number" required="required"/>
      				</div>
      				
      				 <div class="form-group">
      				<input type="password" name="new_password" placeholder="Enter New Password" class="form-email form-control"
      				 id="form-email" pattern="^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,16}$" title="Password must contain 6 characters.In that at least 1 uppercase,1 lowercase,1 special symbol(!,@,#,$,%,^,&,*) and 1 number" required="required"/>
      				</div>
      				
      				<div class="form-group">
      				<input type="password" name="confirm_password" placeholder="Enter Confirm Password" class="form-email form-control"
      				 id="form-email"  required="required" onchange="checkconfirmpass();"/>
      				</div>
