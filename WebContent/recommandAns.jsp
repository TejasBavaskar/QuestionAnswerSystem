...
<html>
  <head>
    ...
    <title>cQA System| Comment</title>
          ...
          <div class="col-xs-12 col-sm-10 col-md-10" align="left">
			   <div class="login-panel panel panel-default">
				<!-- <div class="panel-heading" align="left" style="font-family: Cambria;font-size: 23px;">User Log In</div> -->
			      ...
			      System.out.println("question on comment jsp:"+question);
			      System.out.println("description on comment jsp:"+description);
			      System.out.println("u_email on comment jsp:"+u_email);
			      System.out.println("q_id on comment jsp:"+q_id);
				  %>
                             ...
                             <td>
                                ...
                                <div class="col-sm-11">
                                   ...
                                   <% ResultSet r=userService.likeCount(ans_id);
                                       while(r.next()){%>
                                   <a href="likeController?q_id=<%=q_id%>&question=<%=question%>&description=<%=description%>&ans_id=<%=ans_id%>&user_email=<%=email%>&like=<%=like%>&email=<%=u_email%>">
                                       <img src="Images/like.png"class="img-rounded" width="25px" height="25px" alt="Like">
                                   </a><%=r.getInt(1) %>
                                   <%} %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="comment.jsp?q_id=<%=q_id%>&question=<%=question%>&description=<%=description%>&u_email=<%=u_email%>">Comment</a><br><br>
                                     <%--  <h5><b>Comments</b></h5>
                                    
                                                  <% 
 			                                         ResultSet rset=userService.selectComments(ans_id);
 			                                         while(rset.next()){
 			                                       %>  
                                             <div class="user-panel">
                                                <div class="col-sm-1">
                                                 <div class="pull-left image">
                                                    <img src="userProfilePic.jsp?u_email=<%=rset.getString(5) %>" class="img-circle" width="30px" height="30px" alt="User Image">
                                                 </div>
                                                 </div>
                                                 <div class="col-sm-11">
                                                    <p><%=rset.getString(4) %></p>
                                                </div>  
                                              </div><%} %> --%>
                                              <div class="user-panel">
                                             <!--  <div class="col-sm-1">
                                                 <div class="pull-left image">
                                                    <img src="Images/user.png" class="img-circle" width="30px" height="30px" alt="User Image">
                                                 </div>
                                                 </div> -->
                                                 <div class="col-sm-11">
                                                       <div class="col-xs-11 col-sm-8 col-md-8" align="left">
			                                                <div class="login-panel panel panel-primary">
			                                                <div class="panel-heading">Recommand Answer</div>
				                                               <div class="panel-body">
					                                             <form role="form"  action="recommandAnsController" method="post">
						                                         <fieldset>
							                                      <div class="form-group">
							                                      <input type="email" id="useremail" name="emailToRecommand" pattern="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" 
					                                                      title="Enter valid email id" required="required"
						                                                   class="form-control" placeholder="Enter EmailID Here.."> 
							                                      <!-- <textarea rows="3" cols="45" name="comment" placeholder="Add Your Comment..."></textarea>	 -->
							                                       </div>
