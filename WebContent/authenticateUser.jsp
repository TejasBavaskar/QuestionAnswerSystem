    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="col-lg-12 connectedSortable">
			...
			<div class="col-md-10">
			<h2 align="center" style="color:#990099;font-family:Cambria;font-size:25px;">View All Users</h2><br>
		    <form method="post">
        ...
        %>
           <TR>
               ...
               <TD> <a href="authenticateController?u_id=<%=rs.getInt(1)%>&status=<%= rs.getString(8) %>"><%= rs.getString(8) %></a></TD>
