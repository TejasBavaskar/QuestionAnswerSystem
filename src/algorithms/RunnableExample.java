...
public class RunnableExample {
    ...
    public static void main(String[] args) {
         ...
         */
        final String[] positiveText = " love sunny like good ".split("\\s");
        bayes.learn("positive", Arrays.asList(positiveText));

        final String[] negativeText = "hate not worst".split("\\s");
         ...
         */
        final String[] unknownText1 = "today is a  sunny day but I do not like".split("\\s");
