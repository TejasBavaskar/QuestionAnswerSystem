...
public class BayesClassifier<T, K> extends Classifier<T, K> {
    ...
    private float categoryProbability(Collection<T> features, K category) {
    	System.out.println("categoryount--------:"+(float) this.categoryCount(category));
    	System.out.println("categoryTotal********:"+(float) this.getCategoriesTotal());
    	System.out.println("FeaturesProbability]]]]"+featuresProbabilityProduct(features, category));
        ...
        SortedSet<Classification<T, K>> probabilities =
                new TreeSet<Classification<T, K>>(
                    ...
                    public int compare(Classification<T, K> o1,
                    	...
                    	System.out.println("Object 1:::::"+ o1.getProbability());
