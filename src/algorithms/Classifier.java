...
public abstract class Classifier<T, K> implements IFeatureProbability<T, K> {
    ...
    public void incrementFeature(T feature, K category) {
    	/*This is equal to telling the classifier, that this feature has occurred in this 
        * category. */
        ...
        /*telling the classifier, that this category has occurred once more. */
       ...
       // System.out.println("feature::"+feature+"  count::"+count);
    ...
    public void learn(Classification<T, K> classification) {
    	//System.out.println("Getfeature : "+classification.getFeatureset());
